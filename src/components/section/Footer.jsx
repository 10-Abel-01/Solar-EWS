...
const Footer = () => {
  return (
    <footer id="footer" className="mt-12 p-6 text-center bg-black text-gray-600 text-sm border-t border-white/5">
      <h1 className="text-center m-4 text-2xl font-bold text-[1.3rem]">
        CONTACT US
      </h1>
